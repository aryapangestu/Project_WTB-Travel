                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('user_id') is-invalid @enderror"
                                        ...
                                        @foreach ($users as $user)
                                            <option {{ old('user_id', $review->user_id) === $user->id ? 'selected=""' : '' }}
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('place_id') is-invalid @enderror"
                                        ...
                                        @foreach ($places as $place)
                                            <option {{ old('place_id', $review->place_id) === $place->id ? 'selected=""' : '' }}
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select @error('rating') is-invalid @enderror"
                                        ...
                                        <option selected="" disabled="" value="">Choose...</option>
                                        <option {{ old('rating', $review->rating) === 1 ? 'selected=""' : '' }} value="1">1</option>
                                        <option {{ old('rating', $review->rating) === 2 ? 'selected=""' : '' }} value="2">2</option>
                                        <option {{ old('rating', $review->rating) === 3 ? 'selected=""' : '' }} value="3">3</option>
                                        <option {{ old('rating', $review->rating) === 4 ? 'selected=""' : '' }} value="4">4</option>
                                        <option {{ old('rating', $review->rating) === 5 ? 'selected=""' : '' }} value="5">5</option>
                                        @error('rating')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
